...
weight: 6
pagekind: "reading"
summary: "TF*IDF statistics overview."
labels:
  - algorithm
---
...
$$ \mbox{tf}_{t, d} = \begin{cases} \log(1 + \mbox{f}_{t,d}), &\mbox{if f}_{t,d} \gt 0 \\ 0, & \mbox{otherwise} \end{cases} $$ 
...
for all cases where \( \mbox{f}_{t,d} \gt 0\) and \( \mbox{df}_{t} \gt 0 \) , or zero otherwise.
